...
def getUnSignedTasks():
    ...
    res = session.post(url='https://swu.cpdaily.com/wec-counselor-sign-apps/stu/sign/getStuSignInfosInOneDay',
...
def getDetailTask(params):
    ...
    res = session.post(url='https://swu.cpdaily.com/wec-counselor-sign-apps/stu/sign/detailSignInstance',
    ...
    submitForm = {"signInstanceWid": params['signInstanceWid'],
                  ...
                  "isNeedExtra": 1,
                  "extraFieldItems": [
                      {"extraFieldItemValue": "正常，＜37.2℃", "extraFieldItemWid": extraFieldItems[0]['wid']}]
                  }
    return submitForm
...
def submit(form):
    ...
    res = session.post(url='https://swu.cpdaily.com/wec-counselor-sign-apps/stu/sign/submitSign',
